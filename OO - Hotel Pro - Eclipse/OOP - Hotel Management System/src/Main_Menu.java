...
public class Main_Menu extends Customer_Methods{
    ...
    void view_Main_Menu() throws IOException{
		...
		System.out.println(" 3 : Display the names of first three customers who have been allocated to a room");
		System.out.println();
		...
		else if (menuOption.trim().equalsIgnoreCase("3")){
			objCusQ.remove();//calling remove()
		}
		else{
